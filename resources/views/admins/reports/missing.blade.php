        ...
        <div class="col order-0">
            <div class="card mb-3">
                <div class="d-flex align-items-end row">
                    <div class="col">
                        <div class="card-body">
                            <h5 class="card-title text-primary">Missing</h5>
                            <a href="{{ route('report.missing.export') }}" class="btn btn-md btn-outline-success"><span class="tf-icons bx bx-download"></span> Excel</a>
                        </div>
                    </div>
                </div>
            </div>
