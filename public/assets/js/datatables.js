 ...
 *   https://datatables.net/download/#bs5/dt-2.3.4/cc-1.1.0/date-1.6.0/fc-5.0.5/fh-4.0.3
 *
 * Included libraries:
 *   DataTables 2.3.4, ColumnControl 1.1.0, DateTime 1.6.0, FixedColumns 5.0.5, FixedHeader 4.0.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/dt-2.3.4/cc-1.1.0/date-1.6.0/fc-5.0.5/fh-4.0.3",
...
(function( factory ){
	if ( typeof define === 'function' && define.amd ) {
		// AMD
		define( ['jquery', 'datatables.net-bs5', 'datatables.net-columncontrol'], function ( $ ) {
			return factory( $, window, document );
		} );
	}
	else if ( typeof exports === 'object' ) {
